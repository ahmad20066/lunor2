        ...
        <div className="contact-inner reveal">
          ...
          <div className="contact-links">
            <a href="mailto:lunorhairextension@gmail.com" className="contact-link-item">
              ...
              <span dir="ltr">lunorhairextension@gmail.com</span>
            </a>
            <a href="tel:+905523538559" className="contact-link-item">
              <div className="icon">
                <Image src="/phone-call.png" alt="" width={18} height={18} className="contact-link-phone-icon" />
              </div>
              <span dir="ltr">+90 552 353 85 59</span>
            </a>
            <a href="https://www.instagram.com/lunor_hair/" target="_blank" rel="noopener noreferrer" className="contact-link-item">
              ...
              <span dir="ltr">@lunor_hair</span>
            </a>
            <a href="https://www.facebook.com/lunor.hair/" target="_blank" rel="noopener noreferrer" className="contact-link-item">
              <div className="icon">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                </svg>
              </div>
              <span dir="ltr">lunor.hair</span>
            </a>
            <a href="https://www.tiktok.com/@lunor_hair?lang=en-GB" target="_blank" rel="noopener noreferrer" className="contact-link-item">
              <div className="icon">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor">
